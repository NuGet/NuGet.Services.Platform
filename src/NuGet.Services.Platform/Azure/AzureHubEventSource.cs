...
{
    [EventSource(Name="Outercurve-NuGet-Services-AzureHub")]
    public class AzureHubEventSource : EventSource
    {
        ...
        [Event(
            eventId: 2,
            Level = EventLevel.Error,
            Message = "No Azure Management Certificates found in {0} store.")]
        public void NoMatch(string storeLocation) { WriteEvent(2, storeLocation); }
